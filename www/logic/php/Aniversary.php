...
class Aniversary
{
	...
	public static function install()
	{
		...
		$q="create table if not exists $table(id_fl int primary key auto_increment, owner_fl varchar(20), cal_fl tinyint, opt_fl tinyint unsigned, title_fl varchar(60), exp_fl text, loc_fl int, date_fl datetime)";
		$defdb->run($q);
	}
